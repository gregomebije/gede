        ...
        var data = [
             <?php
                ...
                foreach ($strategy as $name => $value) {
                  echo "{sales:\"" . format_label($value) 
                      . "\", component: \"" 
                      . format_label($name) . "\", color:\""
                      . $color[mt_rand(0, 5)] . "\"}";
    ...
    <table cellpadding="0" cellspacing="0" border="0" 
     ...
     <div id="container3" style="min-width: 400px; height: 400px; 
      ...
      <h3 style='text-align:center;'>
        Frequency distribution of activities per strategy</h3>
     <div id="chart" style="min-width:400px; height: 250px; margin: 0 auto;">
        </div>
